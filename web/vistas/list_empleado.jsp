                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <div class="ml-auto p-2">
                                        <a class="btn btn-success" href="Controlador_empleado?accion_empleado=add_empleado">Nuevo Empleado</a>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center"><%= cli.getRut()%></td>
                                                <td class="text-center"><%= cli.getNombre()%></td>
                                                <td class="text-center"><%= cli.getApellido()%></td>
                                                <td class="text-center"><%= cli.getCelular()%></td>
                                                <td class="text-center"><%= cli.getDpto()%></td>
                                                <td class="text-center"><%= cli.getSbase()%></td>
                                                <td class="text-center">
                                                    <a class="btn btn-warning" href="Controlador_empleado?accion_empleado=editar_empleado&rut=<%= cli.getRut()%>"><i class="icon-pencil"></i></a>
                                                    <a class="btn btn-danger" href="Controlador_empleado?accion_empleado=eliminar&rut=<%= cli.getRut()%>"><i class="icon-trash"></i></a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
