                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <div class="ml-auto p-2">
                                        <a class="btn btn-success" href="Controlador_horasextras?accion_horasextras=add_horasextras">Nuevas Horas</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table" id="myTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Rut empleado</th>
                                         ...
                                         <%
                                            ...
                                            List<Horasextras>list=dao.listar();
                                            Iterator<Horasextras>iter=list.iterator();
                                            Horasextras cli=null;
                                            while(iter.hasNext()){
                                                cli=iter.next();
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center"><%= cli.getFolio()%></td>
                                                <td class="text-center"><%= cli.getFecha()%></td>
                                                <td class="text-center"><%= cli.getTipo_dia()%></td>
                                                <td class="text-center"><%= cli.getCantidad()%></td>
                                                <td class="text-center"><%= cli.getRut_empleado()%></td>
                                                <td class="text-center"><%= cli.getHora_final()%></td>
                                                <td class="text-center">
                                                    <a class="btn btn-warning" href="Controlador_horasextras?accion_horasextras=editar_horasextras&folio=<%= cli.getFolio()%>"><i class="icon-pencil"></i></a>
                                                    <a class="btn btn-danger" href="Controlador_horasextras?accion_horasextras=eliminar&folio=<%= cli.getFolio()%>"><i class="icon-trash"></i></a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
