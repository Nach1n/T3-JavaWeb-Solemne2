                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <div class="ml-auto p-2">
                                        <a class="btn btn-success" href="Controlador_c?accion_c=add_c">Nuevo Cliente</a>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-warning" href="Controlador_c?accion_c=editar_c&rut=<%= cli.getRut()%>"><i class="icon-pencil"></i></a>
                                                    <a class="btn btn-danger" href="Controlador_c?accion_c=eliminar&rut=<%= cli.getRut()%>"><i class="icon-trash"></i></a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
