                    ...
                    <div class="card">
                        <div class="card-body">
                              <%
                                ...
                                int rut=Integer.parseInt((String)request.getAttribute("rutcli"));
                                Empleado e=(Empleado)dao.list(rut);
                              %>
                            <form class="form-horizontal" action="Controlador_empleado">
                                <div class="col-2">
                                    <label>Rut</label>
                                </div>
                                <div class="col-4 mt-2">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="txtrut" value="<%= e.getRut()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Nombre</label>
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtnombre" value="<%= e.getNombre()%>">
                                    </div>
                                </div>
                                    <div class="col-2">
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtapellido" value="<%= e.getApellido()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Celular</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtcelular" value="<%= e.getCelular()%>">
                                    </div>
                                </div>
                                    <div class="col-2">
                                    <label>Dpto</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtdpto" value="<%= e.getDpto()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Sbase</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtsbase" value="<%= e.getSbase()%>">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_empleado" value="Actualizar">Editar</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_empleado?accion_empleado=listar_empleado" class="btn btn-info btn-block btn-primary">Cancelar</a>
                                </div>
                            </div>
                            </form>
                        </div>
