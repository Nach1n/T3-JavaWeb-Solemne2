...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <body class="skin-blue fixed-layout">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="btn-group btn-group-lg">
                                                ...
                                                -->
                                                <div>
                                                    <a class="btn btn-warning btn-lg" href="Controlador_empleado?accion_empleado=listar_empleado">Listar Empleados</a>
                                                </div>
                                                <div class="offset-md-3">   
                                                    <a class="btn btn-info btn-lg" href="Controlador_horasextras?accion_horasextras=listar_horasextras">Listar Horas Extras</a>   
                                                </div>      
                                            </div>
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            $('.dropify').dropify({
                messages: {
                    default: 'Arrastre un archivo o haga clic aqui',
