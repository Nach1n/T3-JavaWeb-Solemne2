<%-- 
    Document   : add_f
    Created on : 23-09-2019, 21:16:44
    Author     : luis
--%>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="Controlador_f">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtrut_cliente">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtiva">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Total</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtestado_pago">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_f" value="Agregar">Create</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_f?accion_f=listar_f" class="btn btn-info btn-block btn-primary">Cancel</a>
                                </div>
                            </div>
                            </form>
                        </div>
