                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="Controlador_horasextras">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="txtfolio">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Fecha</label>
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtfecha">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txttipo_dia">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtrut_empleado">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txthora_final">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_horasextras" value="Agregar">Create</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_horasextras?accion_horasextras=listar_horasextras" class="btn btn-info btn-block btn-primary">Cancel</a>
                                </div>
                            </div>
                            </form>
                        </div>
