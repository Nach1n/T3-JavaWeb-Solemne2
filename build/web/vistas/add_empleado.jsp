                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" action="Controlador_empleado">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtdpto">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Sbase</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtsbase">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_empleado" value="Agregar">Create</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_empleado?accion_empleado=listar_empleado" class="btn btn-info btn-block btn-primary">Cancel</a>
                                </div>
                            </div>
                            </form>
                        </div>
