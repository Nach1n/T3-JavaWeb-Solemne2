...
<%@page import="Modelo.Horasextras"%>
<%@page import="ModeloDAO.HorasextrasDAO"%>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li> 
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li><a href="Controlador_empleado?accion_empleado=listar_empleado">Empleados</a></li>

                               
                                    <li><a href="Controlador_horasextras?accion_horasextras=listar_horasextras">Horas extras</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                              <%
                                ...
                                int folio=Integer.parseInt((String)request.getAttribute("foliocli"));
                                Horasextras h=(Horasextras)dao.list(folio);
                              %>
                            <form class="form-horizontal" action="Controlador_horasextras">
                                <div class="col-2">
                                    <label>Folio</label>
                                </div>
                                <div class="col-4 mt-2">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="txtfolio" value="<%= h.getFolio()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Fecha</label>
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtfecha" value="<%= h.getFecha()%>">
                                    </div>
                                </div>
                                    <div class="col-2">
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txttipo_dia" value="<%= h.getTipo_dia()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtcantidad" value="<%= h.getCantidad()%>">
                                    </div>
                                </div>
                                    <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtrut_empleado" value="<%= h.getRut_empleado()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txthora_final" value="<%= h.getHora_final()%>">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_horasextras" value="Actualizar">Editar</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_horasextras?accion_horasextras=listar_horasextras" class="btn btn-info btn-block btn-primary">Cancelar</a>
                                </div>
                            </div>
                            </form>
                        </div>
