                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <div class="ml-auto p-2">
                                        <a class="btn btn-success" href="Controlador_f?accion_f=add_f">Nueva Factura</a>
                                        <a class="btn btn-warning" href="Controlador_f?accion_f=listar_f_e">No pagadas</a>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center"><%= fac.getFolio()%></td>
                                                <td class="text-center"><%= fac.getFecha()%></td>
                                                <td class="text-center"><%= fac.getRut_cliente()%></td>
                                                <td class="text-center"><%= fac.getDescripcion()%></td>
                                                <td class="text-center"><%= fac.getNeto()%></td>
                                                <td class="text-center"><%= fac.getIva()%></td>
                                                <td class="text-center"><%= fac.getTotal()%></td>
                                                <td class="text-center"><%= fac.getEstado_pago()%></td>
                                                <td class="text-center">
                                                    <a class="btn btn-warning" href="Controlador_f?accion_f=editar_f&folio=<%= fac.getFolio()%>"><i class="icon-pencil"></i></a>
                                                    <a class="btn btn-danger" href="Controlador_f?accion_f=eliminar&folio=<%= fac.getFolio()%>"><i class="icon-trash"></i></a>
                                                </td>
                                            </tr>
                                            <%}%>
                                        </tbody>
