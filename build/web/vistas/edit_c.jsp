                    ...
                    <div class="card">
                        <div class="card-body">
                              <%
                                ...
                                String rut=((String)request.getAttribute("rutcli"));
                                Cliente c=(Cliente)dao.list(rut);
                              %>
                            <form class="form-horizontal" action="Controlador_c">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="txtrut" value="<%= c.getRut()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Nombre</label>
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtnombre" value="<%= c.getNombre()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtdireccion" value="<%= c.getDireccion()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Celular</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtcelular" value="<%= c.getCelular()%>">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_c" value="Actualizar">Editar</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_c?accion_c=listar_c" class="btn btn-info btn-block btn-primary">Cancelar</a>
                                </div>
                            </div>
                            </form>
                        </div>
