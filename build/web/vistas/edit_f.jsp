<%-- 
    Document   : edit_f
    Created on : 23-09-2019, 21:17:00
    Author     : luis
--%>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <%
                                ...
                                String folio=((String)request.getAttribute("foliofac"));
                                Factura f=(Factura)dao.list(folio);
                             %>
                            <form class="form-horizontal" action="Controlador_f">
                                <div class="col-2">
                                    <label>Folio</label>
                                </div>
                                <div class="col-4 mt-2">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="txtfolio" value="<%= f.getFolio()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Fecha</label>
                                ...
                                <div class="col-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtfecha" value="<%= f.getFecha()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtrut_cliente" value="<%= f.getRut_cliente()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtdescripcion" value="<%= f.getDescripcion()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Neto</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtneto" value="<%= f.getNeto()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Iva</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtiva" value="<%= f.getIva()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label>Total</label>
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txttotal" value="<%= f.getTotal()%>">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-4 mt-2">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="txtestado_pago" value="<%= f.getEstado_pago()%>">
                                    </div>
                                </div>
                            ...
                            <div class="row spacer">
                                <div class="col-2 offset-2 mt-3">
                                    <button type="submit" class="btn btn-success btn-block btn-primary" name="accion_f" value="Actualizar">Editar</button>
                                </div>
                                <div class="col-2 mt-3">
                                    <a href="Controlador_f?accion_f=listar_f" class="btn btn-info btn-block btn-primary">Cancelar</a>
                                </div>
                            </div>
                            </form>
                        </div>
